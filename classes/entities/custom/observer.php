...
use \local_intellidata\entities\custom\user;
...
class observer {
    ...
    public static function user_created(\core\event\user_created $event) {
        if (TrackingHelper::enabled()) {
            ...
            self::export_event($user, $eventdata['eventname']);
        }
    }
    ...
    public static function user_deleted(\core\event\user_deleted $event) {
        if (TrackingHelper::enabled()) {
            ...
            self::export_event($user, $eventdata['eventname'], ['id']);
        }
    }

    private static function export_event($userdata, $eventname, $fields = []) {
